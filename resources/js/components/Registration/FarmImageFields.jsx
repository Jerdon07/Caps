...
export default function FarmImage({ data, setData }) {
    ...
    return (
        <>
            <div className="text-center">
                <h1 className="inline-flex items-center justify-center gap-1 font-bold md:text-2xl">
                    <Images /> Showcase your fields
                </h1>
            </div>
